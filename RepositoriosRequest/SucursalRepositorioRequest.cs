...
namespace proyecto_centauro.RepositoriosRequest
{
    public class SucursalRepositorioRequest : ISucursalRepositorioV
    {
        private readonly string _connectionString;
        private readonly IMapper _mapper;

        public SucursalRepositorioRequest(IConfiguration configuration, IMapper mapper) // constructor
        {
